...
*/
let lowCaseAnimalNames = zooAnimals.map(lowcase =>
  lowcase.animal_name.toLocaleLowerCase()
);
...
*/
let lowPopulationAnimals = zooAnimals.filter(smallpopulation => {
  if (smallpopulation.population < 5) {
    return true;
  }
});
